...
export const LOCAL_SERVICE_IMAGES: Record<ServiceSlug, string> = {
  ...
  "door-glass-replacement": "/images/services/Door-Glass-Replacement.png",
  "mirror-glass-replacement": "/images/services/Mirror-Glass-Replacement.png",
  "residential-glass-installation": "/images/services/Residential-Glass-Installation.png",
  "commercial-glass-installation": "/images/services/Commercial-Glass-Installation.png",
  ...
  "storefront-glass-doors": "/images/services/Commercial-Storefront-Glass-and-Doors.png",
...
export const MEDIA = {
  ...
  commercial: {
    storefront: u("photo-1486406146926-c627a92ad1ab"),
    officeGlass: u("photo-1497366216548-37526070297c"),
    retail: u("photo-1497366811353-6870744d04b2"),
  },
  work: {
    measure: u("photo-1503387762-592deb58ef4e"),
    technician: u("photo-1581578731548-c64695cc6952"),
    tools: u("photo-1504307651254-35680f356dfd"),
    consult: u("photo-1560518883-ce09059eeffa"),
  },
  beforeAfter: {
    showerBefore: u("photo-1584622650111-993a426fbf0a"),
    showerAfter: u("photo-1620626011761-996317b8d101"),
...
export const SERVICE_IMAGES: Record<ServiceSlug, ServiceImageSet> = {
  ...
  "door-glass-replacement": {
    ...
    process: MEDIA.work.technician,
    completed: MEDIA.commercial.officeGlass,
    gallery: [
  ...
  "commercial-glass-installation": {
    ...
    overview: MEDIA.commercial.officeGlass,
    detail: MEDIA.commercial.storefront,
    process: MEDIA.work.measure,
    completed: MEDIA.work.technician,
    gallery: [
      ...
      MEDIA.heroes.commercialStorefront,
      MEDIA.work.technician,
    ],
  },
  "vinyl-windows": {
  ...
  "storefront-glass-doors": {
    ...
    overview: MEDIA.heroes.commercialStorefront,
    detail: MEDIA.commercial.retail,
    process: MEDIA.work.measure,
    completed: MEDIA.work.technician,
    gallery: [
...
export const PAGE_IMAGES = {
  home: {
    ...
    residential: MEDIA.residential.homeExterior,
    commercial: MEDIA.commercial.storefront,
    cta: MEDIA.work.measure,
    process: [
      MEDIA.work.consult,
      MEDIA.work.measure,
      MEDIA.work.tools,
  ...
  services: {
    hero: MEDIA.heroes.commercialStorefront,
  ...
  legal: {
    ...
    terms: MEDIA.heroes.commercialStorefront,
...
export const SHOWCASE_GALLERY: ShowcaseGalleryItem[] = [
  ...
  {
    url: MEDIA.commercial.officeGlass,
  ...
  },
  {
    ...
    alt: "Storefront glass and doors",
    caption: "Storefront system",
